const icons = {
  ...
  refresh: <><path d="M20 7v5h-5" /><path d="M4 17v-5h5" /><path d="M6.1 8a7 7 0 0 1 11.6-2.2L20 8" /><path d="m4 16 2.3 2.2A7 7 0 0 0 17.9 16" /></>,
  ...
  star: <path d="m12 2.8 2.8 5.7 6.3.9-4.6 4.4 1.1 6.3-5.6-2.9-5.6 2.9 1.1-6.3-4.6-4.4 6.3-.9L12 2.8Z" />,
