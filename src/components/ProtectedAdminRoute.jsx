  ...
  if (!user) {
    return (
      <Container className="access-state page-section">
        ...
        <p>Sign in with the Google account assigned to the studio administrator. Buyer accounts cannot access this area.</p>
        <Button className="button-burgundy" onClick={() => openAuth('Use the studio administrator Google account to continue.')}>Sign in securely</Button>
      </Container>
    );
  }
